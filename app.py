...
#upload file fct
def file_selector(folder_path="C:\\Users\\CHAHRAZED\\OneDrive\\Desktop\\streamlit\\ML_Dataset_Explorer\\datasets"):
...
def main():
	...
	st.subheader("Simple ML App with Stremalit")
	html_temp="""
	<div style="background-color:tomato;"><p style="color:white;font-size:60px;text-align: center">Data Science</p></div>
	"""
	...
	if st.checkbox("Show DataSet"):
		number = st.number_input("Number of Rows to View",1,10)
